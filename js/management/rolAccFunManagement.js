...
function populateRow(tableElement, roles, functionality, action, rolAccFun){
    ...
    for(let i = 0; i < roles.length; i++){
        if(rolesWithPermissions.includes(roles[i].id_rol)){
            //disable 0
            cells[i+2].innerHTML = '<img src="images/plus_color_green.svg" class="svg add imageButtonDisabled"> <img src="images/minus_color_red.svg" class="svg delete">';
            ...
            //disable 1
            cells[i+2].innerHTML = '<img src="images/plus_color_green.svg" class="svg add"> <img src="images/minus_color_red.svg" class="svg delete imageButtonDisabled">';
